...
import TextType from "@/components/bits/typedtext";
          ...
          <div className="mx-auto max-w-3xl px-4">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Button asChild size="lg">
                <Link
                  href={isLoggedIn ? "/exam" : "/login"}
                  onClick={handleStartExamClick}
                >
                  {isLoggedIn
                    ? "Start Your Secure Exam"
                    : "Login to Start Exam"}{" "}
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Our platform uses state-of-the-art technology to provide a
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-2 text-muted-foreground">
                Your exam session is locked and monitored to prevent
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-2 text-muted-foreground">
                Your camera and microphone are used to monitor the exam session
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-2 text-muted-foreground">
                Our AI analyzes the recording for suspicious behavior and
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-2 text-muted-foreground">
                Get your score and a detailed report immediately after
                completing the exam.
              </p>
            </div>
          </div>
